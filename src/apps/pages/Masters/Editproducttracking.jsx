    ...
    <React.Fragment>
      <Box display="flex" justifyContent="space-between" p={2}>
        <Box display="flex" borderRadius="3px" alignItems="center">
          <Typography variant="h3">Product Price List</Typography>
        </Box>
        <Box display="flex">
        <Tooltip title="Close">
          ...
          {({}) => (
            <form>
              ...
              <Box display="flex" justifyContent="end" mt="20px" gap="20px">
                <Button onClick={priceTrackingFn} variant="contained" color="secondary">
                  APPLY
                </Button>
                <Button onClick={()=>{
                   setCompanyLookup({
...
export default Editproducttracking;
