...
const Editproformainvoice = () => {
  ...
  const initialValues = {
    ...
    Customs: Data.Customs == "Y" ? true : false,
  ...
  const trailerinitialValues = {
    ...
    addtrailer:DataExplore.Add1,
    amounttrailer:DataExplore.Amount,
    amounttrailer1:DataExplore.Amount1,
  ...
  const fnaccountSave = async (values, types) => {
    ...
    var saveData = {
      ...
      Finyear,
      CompanyID,
      // BeneficiaryBankerID:selectBeneficiaryBankLookupData.beneficiaryBankRecordID,
      // BeneficiaryID:selectBeneficiaryLookupData.beneficiaryRecordID,
      BeneficiaryBankerID:0,
      BeneficiaryID:0,
    };
    var type = "";
    if (types === "harddelete") {
  ...
  const fnTralierSave = async (values, types) => {
    ...
    var saveData = {
      ...
      Amount:values.amounttrailer,
      Add1:values.addtrailer,
      Amount1:values.amounttrailer1,
      Finyear,
      CompanyID,
    };
    var type = "";
  ...
  const fnSave = async (values, types) => {
    ...
    var saveData = {
      ...
      CompanyID,
      Finyear,
      Customs: values.Customs == true ? "Y" :"N",
      Orderdate: values.Orderdate  ? values.Orderdate :''
    };
    var type = "";
  ...
  const detailInitialvalues = {
    ...
    Rate:
      parentID == "P"
        ? Number(leatherLookup.ProductCost).toFixed(2): parentID == "L" ?  Number(detaildata.Rate).toFixed(2)
  ...
  const fngpCard = async (values) => {
    ...
    saveData = {
      ...
      SecondaryLeatherID: secondaryLeatherLookup.recordID,
      TeriteryLeatherID: tertiaryLeatherLookup.recordID
      // CompanyID,
    };
...
{invoicefilter == "FI" && parentID == "L" ? (
  ...
  function handleShow(type) {
    if (type == "BENFEBANK") {
      setOpenBeneficiaryBankPopup(true);
    }
    if (type == "BENFE") {
      setOpenBeneficiaryPopup(true);
    }
    if (type == "CTY") {
 ...
 if (isPopupData == false) {
  ...
  const [openBeneficiaryPopup, setOpenBeneficiaryPopup] = useState(false);
  const [selectBeneficiaryLookupData, setselectBeneficiaryLookupData] = React.useState({
    beneficiaryRecordID: "",
    beneficiarycode: "",
    beneficiarydescription: "",
  });

  const [openBeneficiaryBankPopup, setOpenBeneficiaryBankPopup] = useState(false);
  const [selectBeneficiaryBankLookupData, setselectBeneficiaryBankLookupData] = React.useState({
    beneficiaryBankRecordID: "",
    beneficiaryBankcode: "",
    beneficiaryBankdescription: "",
  });
  if (isPopupData == false) {
    selectdirectorLookupData.directorRecordID = DataExplore.DirectorsID;
    selectdirectorLookupData.directorcode = DataExplore.DirectorName;
    selectdirectorLookupData.directordescription = DataExplore.DirectorName;
  }

  if (isPopupData == false) {
    selectBeneficiaryBankLookupData.beneficiaryBankRecordID = DataExplore.BeneficiaryBankerID;
    selectBeneficiaryBankLookupData.beneficiaryBankcode = DataExplore.BeneficiaryBankerCode;
    selectBeneficiaryBankLookupData.beneficiaryBankdescription = DataExplore.BeneficiaryBankerName;
  }

  if (isPopupData == false) {
    selectBeneficiaryLookupData.beneficiaryRecordID = DataExplore.BeneficiaryID;
    selectBeneficiaryLookupData.beneficiarycode = DataExplore.BeneficiaryCode;
    selectBeneficiaryLookupData.beneficiarydescription = DataExplore.BeneficiaryName;
  }
  ...
  const childToParent = async (childdata, type) => {
    ...
    if (type == "Product") {
      ...
      if ((childdata.BomCount) == "1") {
        await setselectBOMLookupData({
          ...
          bomID:dataBom.payload.Data.RecordID
    ...
    if (type == "Beneficiary Bankers") {
      setselectBeneficiaryBankLookupData({
        beneficiaryBankRecordID: childdata.RecordID,
        beneficiaryBankcode: childdata.Code,
        beneficiaryBankdescription: childdata.Name,       
      })
      setOpenBeneficiaryBankPopup(false);
    }

    if (type == "Beneficiary") {
      setselectBeneficiaryLookupData({
        beneficiaryRecordID: childdata.RecordID,
        beneficiarycode: childdata.Code,
        beneficiarydescription: childdata.Name,       
      })
      setOpenBeneficiaryPopup(false);
    }
  };
              ...
              {({
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    ...
                    {(invoicefilter == "FI" && parentID == "L") || (invoicefilter == "FI" && parentID == "P")? <><Box
                   sx={{
                     display: "flex",
                     flexDirection: "row",
                     alignItems: "center",
                 ...
                 >
                  ...
                  <TextField
                        ...
                        sx={{ background: "#ffe5f1",gridColumn: "span 2" }}
                        onInvalid={(e) => {
                          e.target.setCustomValidity("Please Fill The Order Date");
                        }}
                        onInput={(e) => {
                          e.target.setCustomValidity("");
                        }}
                   ...
                   <FormControl sx={{ gridColumn: "span 2", mt: "20px" }}>
                    <Field
                      ...
                      id="Customs"
                      as={FormControlLabel}
                      control={<Checkbox checked={values.Customs} />}
                      label="Customs"
                    />
                    </FormControl>:false}
                  </Box>
                    ...
                    >
                      <Formik
                        ...
                        onSubmit={(values, { resetForm }) => {
                          setTimeout(() => {
                            invoicefilter == "FI" && parentID == "P" && !values.Sample
                                    ...
                                    <Button
                                      ...
                                      onClick={() => {
                                        Swal.fire({
                                          ...
                                          if (result.isConfirmed) {
                                            fnDetailsave(values, resetForm, true);
                                   ...
                                   {selectBOMLookupData.bomCount != "0" ? <FormControl
                                    ...
                                    >
                                      <Listviewpopup
                                        ...
                                        screenName="Primary Leather"
                                        childToParent={childToParent}
                                        filterValue={boMode == 'A' ? `${costingLookup.costingRecID}' AND PrimaryTypeID='${costingLookup.PrimaryLeatherID}` : `${costingLookup.costingRecID}' AND PrimaryTypeID='${costingLookup.PrimaryLeatherID}' AND RecordID='${leatherLookup.leatherRecID}`}
                                        filterName="parentID"
                                      />
                                    </Popup>
                                    <Popup
                                    ...
                                    >
                                      <Listviewpopup
                                        ...
                                        screenName="Secondary Leather"
                                        childToParent={childToParent}
                                        filterValue={boMode == 'A' ?`${costingLookup.costingRecID}' AND SecondaryTypeID='${secondaryTypeLeatherLookup.SecondaryTypeLeatherID}`: `${costingLookup.costingRecID}' AND SecondaryTypeID='${secondaryTypeLeatherLookup.SecondaryTypeLeatherID}' AND RecordID='${secondaryLeatherLookup.recordID}`}
                                        filterName="parentID"
                                      />
                                    </Popup>
                                    <Popup
                                    ...
                                    >
                                      <Listviewpopup
                                        ...
                                        screenName="Tertiary Leather"
                                        childToParent={childToParent}
                                        filterValue={boMode == 'A' ? `${costingLookup.costingRecID}' AND TertiaryTypeID='${tertiaryTypeLeatherLookup.TertiaryTypeLeatherID}`:`${costingLookup.costingRecID}' AND TertiaryTypeID='${tertiaryTypeLeatherLookup.TertiaryTypeLeatherID}' AND RecordID='${tertiaryLeatherLookup.recordID}`}
                                        filterName="parentID"
                                      />
                                    </Popup>
                    ...
                    >
                      ...
                      <MenuItem value="CO">by Courier</MenuItem>
                            ...
                            <TextField
                              ...
                              focusedonWheel={(e) => e.target.blur()} 
                              InputProps={{
                                inputProps: {
                                  style: { textAlign: "right" },
                                },
                    ...
                    <FormControl sx={{ gridColumn: "span 4", gap: "40px" }}>
                      ...
                      >
                        ...
                        {/* <Divider variant="fullWidth" sx={{ mt: "20px" }} />
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                   <TextField
                                    id="outlined-basic"
                                    label="Beneficiary Bankers"
                                    variant="filled"
                                    value={selectBeneficiaryBankLookupData.beneficiaryBankcode}
                                    focused
                                    inputProps={{ tabIndex: "-1" }}
                                  />
                                  ...
                                  <TextField
                                    ...
                                    variant="filled"
                                    value={
                                      selectBeneficiaryBankLookupData.beneficiaryBankdescription
                                    }
                                    fullWidth
                                    inputProps={{ tabIndex: "-1" }}
                                    focused
                              ...
                              >
                                ...
                                >
                                   <TextField
                                    ...
                                    label="Beneficiary"
                                    variant="filled"
                                    value={selectBeneficiaryLookupData.beneficiarycode}
                                    focused
                                    inputProps={{ tabIndex: "-1" }}
                                  />
                                  ...
                                  <TextField
                                    ...
                                    variant="filled"
                                    value={
                                      selectBeneficiaryLookupData.beneficiarydescription
                                    }
                                    fullWidth
                                    inputProps={{ tabIndex: "-1" }}
                                    focused
                          ...
                          {invoicefilter == "PI" || invoicefilter == "PI" ?
                          <> <Divider variant="fullWidth" sx={{ mt: "20px" }} />
                            <Typography variant="h5">
                              Account details :
                            </Typography>
                            ...
                            >
                              ...
                              <Popup
                              title="Beneficiary Bankers"
                              openPopup={openBeneficiaryBankPopup}
                              setOpenPopup={setOpenBeneficiaryBankPopup}
                            >
                              <Listviewpopup
                                accessID="2006"
                                screenName="Beneficiary Bankers"
                                childToParent={childToParent}
                                filterName={"compID"}
                                filterValue={CompanyID}
                              />
                              ...
                              <Popup
                              title="Beneficiary"
                              openPopup={openBeneficiaryPopup}
                              setOpenPopup={setOpenBeneficiaryPopup}
                            >
                              <Listviewpopup
                                accessID="2006"
                                screenName="Beneficiary"
                                childToParent={childToParent}
                              />
                              </Popup>
                            <Box
