...
const TotalGrowthBarChart = ({ isLoading }) => {
    ...
    console.log("🚀 ~ file: BarChart.jsx:113 ~ TotalGrowthBarChart ~ seriesData:", seriesData)

    useEffect(() => {
        dispatch(stockRequirementFetchapiData(finYear))
    },[])
                ...
                <MainCard> */}
                    <Grid container spacing={1}>
                            ...
                            <Grid container alignItems="center" justifyContent="space-between">
                                <Grid item>
                                    <Grid container direction="column" spacing={1}>
                                        <Grid item>
                                            <Typography variant="subtitle2">Production Stock Requirements</Typography>
                                        </Grid>
                        ...
                        <Grid item xs={12} sx={{height:'400px',overflowY:"auto"}}>
                            ...
                            <Chart
                            height={seriesData ? seriesData.categories.length * 20 : "300px"}
